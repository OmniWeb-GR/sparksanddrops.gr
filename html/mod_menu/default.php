...
<?php if ($tagId == 'mobile-menu') : ?>
	<ul class="dropdown-menu dropdown-menu-end" aria-labelledby="mobile-menu-more">
		...
		<li>
			<a class="dropdown-item" href="https://www.instagram.com/sparksanddrops/" aria-label="Instagram">
		...
		<li>
			<a class="dropdown-item" href="https://www.facebook.com/SparksandDrops" aria-label="Facebook">
		...
		<li>
			<a class="dropdown-item" href="https://www.pinterest.com/sparksanddrops/" aria-label="Pinterest">
